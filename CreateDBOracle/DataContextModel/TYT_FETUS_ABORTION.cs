namespace CreateDBOracle.DataContextModel
{
    ...
    [Table("SAR_RS.TYT_FETUS_ABORTION")]
    public partial class TYT_FETUS_ABORTION
    {
        ...
        public long? DIAGNOSE_TEST { get; set; }

        [StringLength(100)]
        public string ABORTION_METHOD { get; set; }

        public long? SM_RESULT { get; set; }
        ...
        public short? EXAM_AFTER_TWO_WEEK { get; set; }

        [StringLength(100)]
        public string NOTE { get; set; }

        public long? ABORTION_TIME { get; set; }
    }
}
