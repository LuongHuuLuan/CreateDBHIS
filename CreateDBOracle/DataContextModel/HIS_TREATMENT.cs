namespace CreateDBOracle.DataContextModel
{
    ...
    public partial class HIS_TREATMENT
    {
        ...
        public HIS_TREATMENT()
        {
            ...
            HIS_ADR = new HashSet<HIS_ADR>();
            HIS_ALLERGY_CARD = new HashSet<HIS_ALLERGY_CARD>();
            ...
            HIS_HIV_TREATMENT = new HashSet<HIS_HIV_TREATMENT>();
            ...
            HIS_PREPARE = new HashSet<HIS_PREPARE>();
            HIS_REHA_SUM = new HashSet<HIS_REHA_SUM>();
            ...
            HIS_TRANS_REQ = new HashSet<HIS_TRANS_REQ>();
            ...
            HIS_TREATMENT_FILE = new HashSet<HIS_TREATMENT_FILE>();
            HIS_TREATMENT_LOGGING = new HashSet<HIS_TREATMENT_LOGGING>();
            HIS_TREATMENT_UNLIMIT = new HashSet<HIS_TREATMENT_UNLIMIT>();
        }
        ...
        public short? IS_PREGNANCY_TERMINATION { get; set; }

        [StringLength(4000)]
        public string PREGNANCY_TERMINATION_REASON { get; set; }

        public long? GESTATIONAL_AGE { get; set; }

        public long? DEATH_CERT_BOOK_FIRST_ID { get; set; }

        public long? DEATH_CERT_NUM_FIRST { get; set; }
        ...
        public long? DEATH_SYNC_TIME { get; set; }

        public long? PREGNANCY_TERMINATION_TIME { get; set; }
        ...
        public short? DEATH_DOCUMENT_TYPE_CODE { get; set; }

        public short? DEATH_STATUS { get; set; }

        public long? NUMBER_OF_BIRTH { get; set; }

        public long? DEATH_ISSUED_DATE { get; set; }
