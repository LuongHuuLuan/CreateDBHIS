namespace CreateDBOracle.DataContextModel
{
    ...
    [Table("SAR_RS.V_HIS_TREATMENT_5")]
    public partial class V_HIS_TREATMENT_5
    {
        ...
        public long? APPOINTMENT_PERIOD_FROM_HOUR { get; set; }

        public long? APPOINTMENT_PERIOD_FROM_MINUTE { get; set; }

        public long? APPOINTMENT_PERIOD_TO_HOUR { get; set; }

        public long? APPOINTMENT_PERIOD_TO_MINUTE { get; set; }
    }
}
